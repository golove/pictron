...
export default defineComponent({
  ...
  setup () {
    ...
    ipcRenderer.send('Selfie-message', { url: 'https://k6.c5cbca7s.pw/pw/thread.php?fid=15', reload: reload.value })
    ipcRenderer.on('Selfie-reply', (event, arg) => {
      // console.log(arg)
      if (arg) {
        imgCard.push(arg)
      }
    })
    ipcRenderer.on('Selfie-replyFlag', (event, arg) => {
      reload.value = arg
    })
